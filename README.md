...
[![Update packages](https://github.com/radxa-repo/trixie/actions/workflows/update.yaml/badge.svg)](https://github.com/radxa-repo/trixie/actions/workflows/update.yaml)

## Content

* [Published GitHub Releases](https://radxa-repo.github.io/trixie/pkgs.json)
* [File index](https://radxa-repo.github.io/trixie/files.list)
...
curl https://radxa-repo.github.io/trixie/install.sh | sh
```
